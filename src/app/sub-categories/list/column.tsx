...
const columnHelper = createColumnHelper<SubCategoryType>();
...
export const subCategoriesListColumns = [
    ...
    columnHelper.display({
        ...
        size: 150,
        header: 'Category',
        cell: ({ row }) => <Text className="text-sm">{row.original.category}</Text>,
    }),
        ...
        cell: ({
            ...
            <Flex align="center" justify="end" gap="3" className="pe-4">
                ...
                <DeletePopover
                    ...
                    description={`Are you sure you want to delete this #${row.original.id} Sub Category?`}
                    onDelete={() =>
